package com.mojito.learn.knowledge.spring;
...
/**
 * @author liufengqiang
 * @date 2021-06-01 17:39:40
 */
public class SpringCycleTest {

    public static void main(String[] args) {
        SpringCycleTest cycle = new SpringCycleTest();
        cycle.init();
        ...
        SpringCycleTest cycle2 = new SpringCycleTest();
        UserService userService2 = (UserService) cycle2.getBean("userService");
        OrderService orderService2 = (OrderService) cycle2.getBean("orderService");
        System.out.println(userService2.orderService);
        System.out.println(orderService2.userService);
    }
